...
class City:
    ...
    def _calculate_base_production(self) -> RssBaseProduction:
        ...
        base_production: RssBaseProduction = RssBaseProduction()
        
        for building, qty_buildings in self.buildings.buildings.items():
            
            production_per_worker: RssCollection = BUILDINGS.get(building, {}).get("production_per_worker", {})
            max_workers: int = BUILDINGS.get(building, {}).get("max_workers", 0)
